...
path<-"Data/TA/20190203" #the location of all your titration files
massfile<-"20190203mass_RUN2.csv" # name of your file with masses
titrationfile<-'20190203_RUN2.csv'# name of the last titration file run
