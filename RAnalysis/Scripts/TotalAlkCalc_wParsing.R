...
path<-"Data/TA/20190205" #the location of all your titration files
massfile<-"20190205mass_RUN2.csv" # name of your file with masses
titrationfile<-'20190205_RUN2.csv'# name of the last titration file run
