...
path<-"Data/TA/20190128" #the location of all your titration files
massfile<-"20190128mass_RUN2.csv" # name of your file with masses
titrationfile<-'20190128_RUN2.csv'# name of the last titration file run
