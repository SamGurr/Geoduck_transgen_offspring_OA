...
path<-"Data/TA/20190209" #the location of all your titration files
massfile<-"20190209mass_RUN2.csv" # name of your file with masses
titrationfile<-'20190209_RUN2.csv'# name of the last titration file run
