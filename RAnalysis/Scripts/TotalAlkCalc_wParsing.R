...
path<-"Data/TA/20190319" #the location of all your titration files
massfile<-"20190319mass_RUN2.csv" # name of your file with masses
titrationfile<-'20190319_RUN2.csv'# name of the last titration file run
